...
<section class="hero">
    <div class="container custom-container">
        <div class="hero-content">
            ...
            <h1 class="mt-3" style="font-weight: 800;">"We <span class="text-custom">SANKHARA Group</span>  is a community of innovators committed to delivering exceptional products and services that inspire creativity and drive sustainable growth."</h1>
            ...
            <div class="item">
                <div class="testimonial-card bg-20 p-4 text-custom-gray">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <img src="assets/images/testi/RevathiM2.jpg" alt="User Image" class="user-image me-3">
